...
function Dot({ to, title = 'Source', toCopy = title, canCopy = false }) {
  ...
  return (
    <Link
      bg={useColorModeValue('#18181b', '#fafafa')}
    ...
    >
      <Text
        bg={useColorModeValue('#85586f', '#42032c')}
        _before={{ bg: useColorModeValue('#85586f', '#42032C') }}
        textColor="#d4d4d8"
